...
function AboutPage() {
  ...
  />
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, textAlign: 'center', py: 6 }}>
          ...
          <Button
            ...
            sx={{
              ...
              fontWeight: 'bold',
              '&:hover, &:focus': { backgroundColor: '#0d6dfdd4', color: '#f8f9fa', outline: 'none' },
      ...
      <Box component="section" id="scroll-target" aria-label="Our founding story" sx={{ py: 8, backgroundColor: '#f8f9fa' }}>
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid size={{ xs: 12, lg: 6 }}>
              <Box sx={{ pl: { lg: 4 } }}>
                <Typography component="h2" variant="h2" sx={{ fontWeight: 800, mb: 3, color: '#1a1a1a', fontSize: { xs: '2rem', md: '2.5rem' } }}>
                  Our founding
                </Typography>
                <Typography component="p" variant="body1" sx={{ fontWeight: 400, color: '#666', lineHeight: 1.7, fontSize: '1.2rem' }}>
      ...
      <Box component="section" aria-label="Growth and innovation" sx={{ py: 8, backgroundColor: '#f8f9fa' }}>
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
      ...
      {/* Team Section */}
      <Box component="section" aria-label="Team section" sx={{ py: 8, background: 'linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)' }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 8 }}>
            <Typography component="h2" variant="h2" sx={{ fontWeight: 800, mb: 2, color: '#1a1a1a', fontSize: { xs: '2rem', md: '2.5rem' } }}>
              The Person Behind Atomic Rocket Digital
            </Typography>
            <Typography component="p" variant="body1" sx={{ fontWeight: 400, color: '#666', fontSize: '1.2rem' }}>
                ...
                <Card sx={{
                  ...
                  <CardContent sx={{ p: 4 }}>
                    <Avatar
                      src={member.image}
                      alt={member.name}
                      sx={{ width: 120, height: 120, mx: 'auto', mb: 3, border: '4px solid #fff', boxShadow: '0 8px 25px rgba(0,0,0,0.15)' }}
                    />
                    <Typography sx={{ fontWeight: 700, mb: 1 }}>{member.name}</Typography>
                    <Typography variant="body2" sx={{ fontStyle: 'italic', color: '#666', fontSize: '0.95rem', mb: 2 }}>{member.role}</Typography>
                    <Typography variant="body1" sx={{ color: '#1a1a1a', lineHeight: 1.6 }}>{member.text}</Typography>
                  </CardContent>
                </Card>
              </Grid>
            ))}
